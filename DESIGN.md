...
| Auth Background | app-owned `AuthBackground.tsx`, no shadcn equivalent — backed by `@paper-design/shaders-react`'s `Dithering` component (WebGL), unrelated to shadcn/Radix |
